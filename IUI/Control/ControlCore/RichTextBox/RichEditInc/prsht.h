...
#define PSP_ALL 		0x007F // ;Internal
...
#define PSH_ALL 		0x00FF // ;Internal
...
#ifdef WIN32
HPROPSHEETPAGE WINAPI CreateProxyPage32Ex(HPROPSHEETPAGE hpage16, HINSTANCE hinst16);	/* ;Internal */
HPROPSHEETPAGE WINAPI CreateProxyPage(HPROPSHEETPAGE hpage16, HINSTANCE hinst16);	/* ;Internal */
#endif
//
...
#define PSBTN_HELP	6
#define PSBTN_MAX	6	// Used internally
...
//
//  Standard sizes for wizard sheet dialogs.  Use these sizes to create
//  wizards that conform to the Chicago standard.
//
