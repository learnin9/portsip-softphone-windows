...
public:
	...
	STDMETHODIMP GetImprint(long *pValue);
	STDMETHODIMP SetImprint(long Value);
...
public:
	...
	STDMETHODIMP GetDoNotHyphen(long *pValue);
	STDMETHODIMP SetDoNotHyphen(long Value);
	STDMETHODIMP GetFirstIndent(float *pValue);
