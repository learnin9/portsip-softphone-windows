...
class CTxtPtr : public CRunPtr<CTxtBlk>
{
	...
	// todo (alexgo) maybe this becomes CTxtRange instead
...
public:
	...
	LONG	FindEOP(LONG cchMax);		//@cmember 	Find next EOP
	LONG	FindExact(LONG cchMax, TCHAR *pch);//@cmember	Find next exact
										// match to <p pch>
