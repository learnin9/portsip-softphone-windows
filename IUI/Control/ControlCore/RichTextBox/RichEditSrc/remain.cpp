	...
	LPARAM lparam)
{
	...
	case WM_GETTEXT:
		...
		if (ped && VER_PLATFORM_WIN32_WINDOWS == dwPlatformId)
		{
			...
			return ped->TxWindowProc(EM_GETTEXTEX, (WPARAM)&gt, lparam);
		}
		break;
	...
	case WM_GETTEXTLENGTH:
		...
		if (VER_PLATFORM_WIN32_WINDOWS == dwPlatformId)
		{
			...
			return ped->TxWindowProc(EM_GETTEXTLENGTHEX, (WPARAM)&gtl,
					0);
		}
		break;
...
// 		return CTxtWinHost::OnNCCreate(hwnd, (CREATESTRUCT *) lparam);
	...
	return ped ? ped->TxWindowProc(msg, wparam, lparam)
