 ...
 *
 */
CTxtArray::CTxtArray() : CReArray<CTxtBlk> ()
{
	...
	Assert(sizeof(CTxtArray) == (sizeof(CReArray<CTxtBlk>) + sizeof(_cchText)));
}
 ...
 *
 *	@todo (alexgo): consider alternate initial models (i.e. a story with
 *	no data)
 */
CTxtStory::CTxtStory()
{
