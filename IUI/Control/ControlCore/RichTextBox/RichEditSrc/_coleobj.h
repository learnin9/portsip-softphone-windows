...
public:
	...
	HRESULT InitFromREOBJECT(DWORD cp, REOBJECT *preobj);
										...
										// outgoing calls)
	void 	MeasureObj(const CDevDesc *pdd, LONG& xWidth, LONG& yHeight, SHORT yDescent);
...
private:
	...
	unsigned int	_fInPlaceActive:1;	//@cmember inplace active? 注意，CTxtEdit中也有个_fInPlaceActive
