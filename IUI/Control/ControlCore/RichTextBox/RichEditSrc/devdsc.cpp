...
HDC CDevDesc::GetMeasureDC(LONG *pyMeasurePerInch) const
{
	...
	if (hdcRet != NULL)
	{
		if (_hdcMeasure123 != NULL)
		{
			hdcRet = _hdcMeasure123;
		}
	...
	else
	{
		...
		*pyMeasurePerInch = yPerInchScreenDC;
	}
...
BOOL CDevDesc::IsMetafile() const
{
	...
	//(HDC)_hdcMeasure123 = (HDC)1;
	return _hdcMeasure123 != NULL;
}
